...
LevelDataStart:
    ...
    db  0                   ; enemy type
    db  15, 14              ; enemy 1st, 2nd color (not used yet)
    ...
    db  0                   ; enemy type
    db  9, 6                ; enemy 1st, 2nd color (not used yet)
    ...
    db  0                   ; action type (0: show enemy)
    db  0                   ; enemy type
    db  7, 5                ; enemy 1st, 2nd color (not used yet)
    ...
    db  0                   ; action type (0: show enemy)
    db  0                   ; enemy type
    db  3, 12               ; enemy 1st, 2nd color (not used yet)
    db  240, TOP_SCREEN     ; enemy position (x, y)
    db  0, 0, 0, 0          ; reserved
    db  0, 0, 0, 0          ; reserved
    ...
    db  0                   ; action type (0: show enemy)
    db  0                   ; enemy type
    db  11, 10              ; enemy 1st, 2nd color (not used yet)
    db  240, TOP_SCREEN     ; enemy position (x, y)
    db  0, 0, 0, 0          ; reserved
    db  0, 0, 0, 0          ; reserved
