Level_5:
.msgLevelName:
    db '    IWO JIMA    ', 0    ; 16 chars fixed size
.seaColor:
...
.levelDataStart:
    ...
    ; Enemy shoots
    db  0x01, 0x02          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
    ...
    ; Enemy shoots
    db  0x01, 0x03          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
    ...
    ; Enemy shoots
    db  0x01, 0x04          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
...
;-------------------------
    ...
    ; Enemy shoots
    db  0x03, 0x02          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
    ...
    ; Enemy shoots
    db  0x03, 0x03          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
    ...
    ; Enemy shoots
    db  0x03, 0x04          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
...
;-------------------------
    ...
    ; Enemy shoots
    db  0x04, 0x82          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
    ...
    ; Enemy shoots
    db  0x04, 0x83          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
...
;-------------------------
    ...
    ; Enemy shoots
    db  0x05, 0x82          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
    ...
    ; Enemy shoots
    db  0x05, 0x83          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
...
;-------------------------
    ...
    ; Enemy shoots
    db  0x06, 0x82          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
    ...
    ; Enemy shoots
    db  0x06, 0x83          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
...
;-------------------------
    ...
    ; Enemy shoots
    db  0x07, 0x82          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
    ...
    ; Enemy shoots
    db  0x07, 0x83          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
...
;-------------------------
    ...
    ; Enemy shoots
    db  0x09, 0xc0          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
    ...
    ; bug: these lines causes the level to end. If it uses 0x09, 0xd1 counter value, works normally
    ; Enemy shoots
    ; db  0x09, 0xc1          ; counter value (HSB, LSB)
    ; db  1                   ; action type (0: show enemy, 1: enemy shoots)
    ; db  0                   ; shot type
    ; db  0, 0                ; shot 1st, 2nd color (not used yet)
    ; db  0, 0                ; shot position (x, y) - not used
    ...
    ; ; Enemy shoots
    ; db  0x09, 0xc2          ; counter value (HSB, LSB)
    ; db  1                   ; action type (0: show enemy, 1: enemy shoots)
    ; db  0                   ; shot type
    ; db  0, 0                ; shot 1st, 2nd color (not used yet)
    ; db  0, 0                ; shot position (x, y) - not used
...
;-------------------------
    ...
    ; Enemy plane (type 2)
    db  0x0a, 0x01          ; counter value (HSB, LSB)
    db  0                   ; action type (0: show enemy, 1: enemy shoots)
    db  2                   ; enemy type
    ...
    ; Enemy plane (type 0)
    db  0x0a, 0x02          ; counter value as bytes (HSB, LSB)
    db  0                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; enemy type
    db  3, 12              ; enemy 1st, 2nd color
    db  85, TOP_SCREEN     ; enemy position (x, y)
    ...
    ; Enemy plane (type 0)
    db  0x0a, 0x12          ; counter value as bytes (HSB, LSB)
    db  0                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; enemy type
    db  10, 11              ; enemy 1st, 2nd color
    db  170, TOP_SCREEN     ; enemy position (x, y)
    ...
    ; Enemy shoots
    db  0x0a, 0x10          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
    ...
    ; Enemy shoots
    db  0x0a, 0x20          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
...
; --------------------------
    ...
    ; Enemy plane (type 0)
    db  0x0c, 0x10          ; counter value as bytes (HSB, LSB)
    db  0                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; enemy type
    db  3, 12               ; enemy 1st, 2nd color
    ...
    ; Enemy plane (type 0)
    db  0x0c, 0x20          ; counter value as bytes (HSB, LSB)
    db  0                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; enemy type
    db  9, 6                ; enemy 1st, 2nd color
    ...
    ; Enemy shoots
    db  0x0c, 0x30          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
    ...
    ; Enemy shoots
    db  0x0c, 0x40          ; counter value (HSB, LSB)
    db  1                   ; action type (0: show enemy, 1: enemy shoots)
    db  0                   ; shot type
    db  0, 0                ; shot 1st, 2nd color (not used yet)
    db  0, 0                ; shot position (x, y) - not used
